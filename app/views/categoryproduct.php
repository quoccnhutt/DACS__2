      ...
      <div class="row">
         <div class="col-12">
            <nav aria-label="breadcrumb">
               <?php
               $name = 'Sản phẩm';
               foreach ($danhmuc_id as $key => $value1) {
                  $name = $value1['title_category_product'];
               }
               ?>
               <ol class="breadcrumb">
   ...
   <div class="row row-flex-reverse">
      ...
      <aside class="right right-content col-lg-9 col-md-8 col-sm-8">
         <div class="box-heading">
            ...
            ?>
            <h1 class="title-head"><?php echo $name  ?></h1>
         </div>
         <section class="list-blogs blog-main">
            <div class="row" style="justify-content: center;">
               <?php foreach ($danhmuc_id as $key => $pro_cate) { ?>
                              ...
                              <div class="row" style="justify-content: center;">
                                 ...
                                 <div class="col-xs-6">
                                    <div class="profile-overview">
                                       ...
                                       <h7>Giá cũ: <?php echo number_format($pro_cate['old_price_product'], 0, ',', '.') . '₫' ?></h7>
                                    </div>
                                 </div>
                              </div>
                           </div>
