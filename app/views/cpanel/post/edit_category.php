                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php foreach ($categorybyid as $key => $cate) { ?>
                            <form class="forms-sample" action="<?php echo BASE_URL ?>postController/update_category/<?php echo $cate['id_category_post'] ?>" method="POST">
                                <div class="form-group">
                                    <label for="exampleInputName1">Tên danh muc</label>
                                    <input type="text" class="form-control" id="exampleInputName1" placeholder="Tên danh mục" name="title_category_post" value="<?= $cate['title_category_post'] ?>" required>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="editor" rows="8" style="height: 100px;" required><?= $cate['description'] ?></textarea>
                                </div>
                                <button type="submit" class="btn btn-primary me-2 btn-sm" name="them_danh_muc_bai_viet">Sửa</button>
                            </form>
                        <?php } ?>
                    </div>
                </div>
